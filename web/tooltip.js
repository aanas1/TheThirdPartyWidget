...
var tooltip = function(z) {
    var i = "length", Gb = "addEventListener", U, gc, Nb = function() {
        ...
        return c
    }, bb = {a: 0, b: 0}, g = null, cc = function(a) {
        if (!a)
            a = window.event;
        bb.a = a.clientX;
        bb.b = a.clientY
        ...
        this.a = [];
        this.b = null
    }, H = "firstChild", xb = 0, x = document, L = "getElementById", Z = navigator, P = "innerHTML", l = function(a, b) {
        return b ? x[a](b) : x[a]
    }, Ib = function() {
        ...
        return c
    }, wb = Ib() < 9, Ab = !!Z.msMaxTouchPoints, db = !!("ontouchstart"in window || window.DocumentTouch && document instanceof DocumentTouch), Lb = (Z.msPointerEnabled || Z.pointerEnabled) && Ab;
    if (Lb)
        var Vb = Z.msPointerEnabled ? "onmspointerout" : "onpointerOut";
    var Qb = function(a) {
        return a.pointerType == a.MSPOINTER_TYPE_MOUSE || a.pointerType == "mouse"
    }, C = "marginTop", ib = "marginLeft", u = "offsetWidth", t = "offsetHeight", vb = "documentElement", X = "borderColor", tb = "nextSibling", a = "style", p = "visibility", J = "width", w = "left", q = "top", S = "height", ec = ["$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22"], v, pb, B = function(c, a, b) {
        return setTimeout(c, a ? a.showDelay : b)
    }, eb = function(a) {
        clearTimeout(a);
        return null
    };
    Kb.prototype = {d: {b: Nb, c: function(a) {
    ...
    var jb = new Kb, h = function(d, b, c, e, a) {
        jb.j(d, b, c, e, a)
    }, dc = [/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/, /.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/, /.*([\w\-])([\w\-])\.com\.[^.]+$/, /^(\w)[^.]*(\w)$/], mb = function(d, a) {
        var c = [];
        if (xb)
            return xb;
        for (var b = 0; b < d[i]; b++)
            c[c[i]] = String.fromCharCode(d.charCodeAt(b) - (a && a > 7 ? a : 3));
        return c.join("")
    }, Ob = function(a) {
            ...
            n.onreadystatechange = function() {
                if (n && n.readyState === 4) {
                    ...
                    if (n.status === 200) {
                        if (k == d && R) {
                            s();
                            var j = c.toLowerCase() == "xml" ? n.responseXML : n.responseText, l = j;
    ...
    Mb.prototype = {j: function(n, i) {
            ...
            f = a.backgroundColor;
            e = a.borderLeftColor;
            c = {a: g.license || "4321", b: d, c: f, d: e, l: b[rb] - b[H][u], m: b[qb] - b[H][t]}
        }, f: function(i, z, y) {
            T = 1;
            s();
            jb.a = [];
            ...
            b.tw = e[u];
            b.th = e[t];
            var r = b.tw + c.l + c.b + c.b, q = b.th + c.m + c.b + c.b, m = this.p(h, r, q);
            if (h.smartPosition)
            ...
            return{x: b + r + a.offsetX, y: d + s + a.offsetY}
        }, u: function(h, d, g, e) {
            if (h < 4)
                f[a][p] = "visible";
            var b;
